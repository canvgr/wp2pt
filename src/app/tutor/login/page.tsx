    ...
    <div className="page-narrow">
      <div className="auth-card">
        <div className="auth-header">
          <div className="auth-role-badge" style={{ background: '#155e3b' }}>Volunteer Tutor Portal</div>
          <h1 style={{ fontSize: '1.6rem', margin: '0.5rem 0 0.25rem', color: 'var(--navy)' }}>Sign In</h1>
