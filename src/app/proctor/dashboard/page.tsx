...
export default function ProctorDashboardPage() {
  ...
  const btnBase: React.CSSProperties = {
    ...
    background: 'white', cursor: 'pointer', textAlign: 'center', transition: 'all 0.15s',
    flex: 1,
  }
  const btnActive: React.CSSProperties = {
    ...btnBase, borderColor: 'var(--navy)', background: 'var(--navy)',
  }
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
              {tutorStats.map((t, i) => (
                <div key={t.id} style={{ background: 'white', border: '0.5px solid var(--border)', borderRadius: '10px', padding: '12px 16px', display: 'flex', alignItems: 'center', gap: '14px' }}>
                  <span style={{ fontFamily: 'system-ui, sans-serif', fontSize: '0.85rem', fontWeight: 700, color: 'var(--text-muted)', minWidth: '20px', textAlign: 'center' }}>
                    {i + 1}
                  </span>
                  ...
                  <div style={{ flex: 2 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '3px' }}>
                      ...
                      <span style={{ fontFamily: 'system-ui, sans-serif', fontWeight: 700, fontSize: '0.9rem', color: 'var(--navy)', minWidth: '52px', textAlign: 'right' }}>
                        {t.mins} min
                      </span>
                    </div>
